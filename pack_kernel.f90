...
SUBROUTINE clover_pack_message_left(x_min,x_max,y_min,y_max,z_min,z_max,field,                 &
                                    ...
                                    depth,field_type,                                          &
                                    buffer_offset,y_offset, z_offset, g_x_max, g_y_max, g_z_max)
  ...
  INTEGER      :: y_offset, z_offset, g_x_max, g_y_max, g_z_max
...
!$OMP PARALLEL DO PRIVATE(index)
  DO l=z_min-depth,z_max+z_inc+depth
    DO k=y_min-depth,y_max+y_inc+depth
      DO j=1,depth
        index=buffer_offset + (j+(k+y_offset+depth-1)*depth) + ((l+z_offset+depth-1)*(g_y_max+y_inc+2*depth)*depth)
...
SUBROUTINE clover_pack_message_top(x_min,x_max,y_min,y_max,z_min,z_max,field,                 &
                                   ...
                                   CELL_DATA,VERTEX_DATA,X_FACE_DATA,Y_FACE_DATA,Z_FACE_DATA, &
                                   depth,field_type,                                          &
                                   buffer_offset,x_offset, z_offset, g_x_max, g_y_max, g_z_max )
  ...
  INTEGER      :: depth,field_type,x_min,x_max,y_min,y_max,z_min,z_max
  INTEGER      :: j,k,l,x_inc,y_inc,z_inc,index,buffer_offset
  INTEGER      :: x_offset, z_offset, g_x_max, g_y_max, g_z_max
...
!$OMP PARALLEL DO PRIVATE(index)
    DO l=z_min-depth,z_max+z_inc+depth
      DO j=x_min-depth,x_max+x_inc+depth
        index= buffer_offset + (j+x_offset+depth) + (l+z_offset-1+depth)*(g_x_max+x_inc+2*depth) + (k-1)*((g_x_max+x_inc+2*depth)*(g_z_max+z_inc+2*depth))
...
SUBROUTINE clover_pack_message_back(x_min,x_max,y_min,y_max,z_min,z_max,field,                 &
                                    ...
                                    CELL_DATA,VERTEX_DATA,X_FACE_DATA,Y_FACE_DATA,Z_FACE_DATA, &
                                    depth,field_type,                                          &
                                    buffer_offset,x_offset, y_offset, g_x_max, g_y_max, g_z_max )
  ...
  INTEGER      :: depth,field_type,x_min,x_max,y_min,y_max,z_min,z_max
  INTEGER      :: j,k,l,x_inc,y_inc,z_inc,index,buffer_offset
  INTEGER      :: x_offset, y_offset, g_x_max, g_y_max, g_z_max
...
!$OMP PARALLEL DO PRIVATE(index)
    DO k=y_min-depth,y_max+y_inc+depth
      DO j=x_min-depth,x_max+x_inc+depth
        index= buffer_offset + (j+x_offset+depth) + (k+y_offset-1+depth)*(g_x_max+x_inc+2*depth) + (l-1)*((g_x_max+x_inc+2*depth)*(g_y_max+y_inc+2*depth))
