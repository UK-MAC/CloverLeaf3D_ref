...
SUBROUTINE start
  ...
  !$ACC DATA &
    ...
    !$ACC COPY(chunk%tiles(1)%field%vertexz)    &
    !$ACC COPY(chunk%tiles(1)%field%vertexdz)   &
    !$ACC COPY(chunk%tiles(1)%field%xarea)      &
    !$ACC COPY(chunk%tiles(1)%field%yarea)      &
    !$ACC COPY(chunk%tiles(1)%field%zarea)      &
